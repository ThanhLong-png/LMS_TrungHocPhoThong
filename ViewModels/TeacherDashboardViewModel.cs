...
namespace LMS_THPT.ViewModels
{
    ...
    public class NhapDiemItem
    {
        ...
        /// <summary>Chế độ chỉ xem (xem lịch sử năm trước, không được chỉnh sửa)</summary>
    ...
    public class ChotDiemRequest
    {
        public int LopId { get; set; }
        public int MonHocId { get; set; }
        public int HocKy { get; set; }
        public string NamHoc { get; set; } = "";
        public string LoaiDiem { get; set; } = ""; // "Mieng", "GiuaKy", "CuoiKy"
    }
}
