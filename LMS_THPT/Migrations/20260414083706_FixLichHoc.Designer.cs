...
namespace LMS_THPT.Migrations
{
    ...
    [Migration("20260414083706_FixLichHoc")]
    partial class FixLichHoc
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMS_THPT.Models.LichHoc", b =>
                {
                    ...
                    b.HasOne("LMS_THPT.Models.MonHoc", null)
                        .WithMany("LichHocs")
                        .HasForeignKey("MonHocId1");
