...
namespace LMS_THPT.Data
{
    public class ApplicationDbContext : IdentityDbContext<NguoiDung>
    {
        ...
        public DbSet<LichSuHocSinh> LichSuHocSinhs { get; set; }
        public DbSet<LichSuDiemHocSinh> LichSuDiemHocSinhs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // --- Quan hệ DiemHocKy ---
            builder.Entity<DiemHocKy>()
                .HasOne(d => d.HocSinh)
                .WithMany(u => u.DiemHocKys)
            ...
            // --- Quan hệ LichSuDiemHocSinh ---
            builder.Entity<LichSuDiemHocSinh>()
                .HasOne(d => d.LichSuHocSinh)
                .WithMany()
                .HasForeignKey(d => d.LichSuHocSinhId)
