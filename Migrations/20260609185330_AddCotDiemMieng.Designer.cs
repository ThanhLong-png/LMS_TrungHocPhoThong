...
namespace LMS_THPT.Migrations
{
    ...
    [Migration("20260609185330_AddCotDiemMieng")]
    partial class AddCotDiemMieng
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS_THPT.Models.DiemHocKy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("Diem15Phut1")
                        .HasColumnType("float");

                    b.Property<double?>("Diem15Phut2")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("DiemMotTiet1")
                        .HasColumnType("float");

                    b.Property<double?>("DiemMotTiet2")
                        .HasColumnType("float");
                    ...
                    b.Property<bool>("IsChotCuoiKy")
                        .HasColumnType("bit");

                    b.Property<bool>("IsChotGiuaKy")
                        .HasColumnType("bit");

                    b.Property<bool>("IsChotMieng")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LMS_THPT.Models.LichSuDiemHocSinh", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LichSuHocSinhId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LichSuHocSinhId");

                    b.ToTable("LichSuDiemHocSinhs");
                });

            modelBuilder.Entity("LMS_THPT.Models.LichSuHocSinh", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DanhSachDiemJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NguoiDungIdGoc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NguoiXoaHoTen")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LMS_THPT.Models.LichSuDiemHocSinh", b =>
                {
                    b.HasOne("LMS_THPT.Models.LichSuHocSinh", "LichSuHocSinh")
                        .WithMany()
                        .HasForeignKey("LichSuHocSinhId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LichSuHocSinh");
                });
